...
public class PlayerView extends FrameLayout implements AdViewProvider {
    ...
    public PlayerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int shutterColor = 0;
        int playerLayoutId = androidx.media3.ui.R.layout.exo_player_view;
            ...
            TypedArray a =
                    context
                            ...
                            .obtainStyledAttributes(
                                    attrs, androidx.media3.ui.R.styleable.PlayerView, defStyleAttr, /* defStyleRes= */ 0);
            try {
                ...
                artworkDisplayMode =
                        a.getInt(androidx.media3.ui.R.styleable.PlayerView_artwork_display_mode, artworkDisplayMode);
                defaultArtworkId =
                        a.getResourceId(androidx.media3.ui.R.styleable.PlayerView_default_artwork, defaultArtworkId);
                ...
                controllerShowTimeoutMs =
                        a.getInt(androidx.media3.ui.R.styleable.PlayerView_show_timeout, controllerShowTimeoutMs);
                controllerHideOnTouch =
                        a.getBoolean(androidx.media3.ui.R.styleable.PlayerView_hide_on_touch, controllerHideOnTouch);
                ...
                keepContentOnPlayerReset =
                        a.getBoolean(
                                androidx.media3.ui.R.styleable.PlayerView_keep_content_on_player_reset, keepContentOnPlayerReset);
                controllerHideDuringAds =
                        a.getBoolean(androidx.media3.ui.R.styleable.PlayerView_hide_during_ads, controllerHideDuringAds);
            } finally {
                a.recycle();
            }
        }
