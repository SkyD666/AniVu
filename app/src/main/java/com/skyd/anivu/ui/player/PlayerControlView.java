...
public class PlayerControlView extends FrameLayout {
    ...
    public PlayerControlView(
        ...
        topBar = findViewById(com.skyd.anivu.R.id.exo_top_bar);
        controlViewLayoutManager.setShowButton(topBar, true);
    }
    ...
    @SuppressWarnings("deprecation")
        // Calling the deprecated listener for now.
    ...
    private final class ComponentListener
        ...
        public void onEvents(Player player, Events events) {
            ...
            if (events.containsAny(EVENT_METADATA, EVENT_MEDIA_ITEM_TRANSITION, EVENT_MEDIA_METADATA_CHANGED)) {
                updateTitle();
            }
        }
