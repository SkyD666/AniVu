...
internal sealed interface DownloadPartialStateChange {
    ...
    sealed interface DeleteDownloadTaskInfoResult : DownloadPartialStateChange {
        override fun reduce(oldState: DownloadState): DownloadState {
            return when (this) {
                is Success -> oldState.copy(
                    loadingDialog = false,
        ...
        data object Success : DeleteDownloadTaskInfoResult
        data class Failed(val msg: String) : DeleteDownloadTaskInfoResult
    }
}
