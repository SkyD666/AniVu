...
/* package */ final class PlayerControlViewLayoutManager {
    ...
    @Nullable
    private final View forward85sButton;
    @Nullable
    ...
    public PlayerControlViewLayoutManager(PlayerControlView playerControlView) {
        ...
        centerControls = playerControlView.findViewById(androidx.media3.ui.R.id.exo_center_controls);

        // Relating to Minimal Layout
        minimalControls = playerControlView.findViewById(androidx.media3.ui.R.id.exo_minimal_controls);

        // Relating to Bottom Bar View
        bottomBar = playerControlView.findViewById(androidx.media3.ui.R.id.exo_bottom_bar);
        ...
        forward85sButton = playerControlView.findViewById(R.id.exo_forward_85s);
        ...
        basicControls = playerControlView.findViewById(androidx.media3.ui.R.id.exo_basic_controls);
        extraControls = playerControlView.findViewById(androidx.media3.ui.R.id.exo_extra_controls);
        extraControlsScrollView = playerControlView.findViewById(androidx.media3.ui.R.id.exo_extra_controls_scroll_view);
        overflowShowButton = playerControlView.findViewById(androidx.media3.ui.R.id.exo_overflow_show);
        View overflowHideButton = playerControlView.findViewById(androidx.media3.ui.R.id.exo_overflow_hide);
        ...
        float translationYForProgressBar =
                resources.getDimension(androidx.media3.ui.R.dimen.exo_styled_bottom_bar_height)
                        - resources.getDimension(androidx.media3.ui.R.dimen.exo_styled_progress_bar_height);
        float translationYForNoBars = resources.getDimension(androidx.media3.ui.R.dimen.exo_styled_bottom_bar_height);
        ...
        hideMainBarAnimator
                ...
                .with(ofAlpha(1, 0, forward85sButton));
        ...
        showMainBarAnimator
                ...
                .with(ofAlpha(0, 1, forward85sButton));
    ...
    private void onOverflowButtonClick(View v) {
        resetHideCallbacks();
        if (v.getId() == androidx.media3.ui.R.id.exo_overflow_show) {
            overflowShowAnimator.start();
        } else if (v.getId() == androidx.media3.ui.R.id.exo_overflow_hide) {
    ...
    private static ObjectAnimator ofAlpha(float startValue, float endValue, View target) {
    ...
    private boolean useMinimalMode() {
        ...
        int defaultModeMinimumHeight = centerControlHeight + getHeightWithMargins(bottomBar)
